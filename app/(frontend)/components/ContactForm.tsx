        ...
        >
          ...
          <div className="relative z-20 flex flex-col gap-[1.036cqw] mt-[3.567cqw] w-[46.145cqw]">
            ...
            <div className="relative">
              ...
              >
                <option value="" className="bg-[#0650DA] text-white">
                  Select a category...
                </option>
                <option value="general" className="bg-[#0650DA] text-white">
                  General Inquiry
                </option>
                <option value="support" className="bg-[#0650DA] text-white">
                  Support
                </option>
                <option value="business" className="bg-[#0650DA] text-white">
                  Business
                </option>
              </select>
