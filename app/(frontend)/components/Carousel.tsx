...
export default function Carousel(props: carouselProps) {
  ...
  return (
    ...
    >
      <div
        ref={carouselRef}
        className="flex h-full overflow-y-auto overflow-x-auto snap-x snap-mandatory scrollbar-none"
      >
        {slides.map((slide, index) => (
          <div
            ...
            className={`w-full snap-center shrink-0 overflow-hidden`}
          >
            {slide}{" "}
            {/*any component won't automatically be contained within this div and any overflow will just be hidden*/}
          </div>
        ))}
      </div>
