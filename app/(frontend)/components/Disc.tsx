    ...
    return (
        <Link href={url} target="_blank">
            <div className={`group relative w-60 h-65 ${color} bg-opacity-10 rounded-xl overflow-hidden`}>
                ...
                <svg viewBox="0 0 100 100" className="absolute top-1/2 left-1/2 z-10 w-20 h-20 overflow-visible pointer-events-none -translate-x-1/2 -translate-y-1/2" style={{ marginLeft: "-4px", marginTop: "5.5px" }}>
                    <defs>
