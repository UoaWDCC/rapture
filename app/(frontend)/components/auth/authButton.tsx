...
export default function AuthButton({ label, onClick, type, theme, size = "default", font = "mono", showGlow = true }: AuthButtonProps) {
  const bgColor = theme === "gold" ? "bg-[#CCA43B] hover:bg-[#F2B423]" : theme === "blue" ? "bg-blue-600 hover:bg-blue-700" : "bg-[#20805A] hover:bg-[#2A9E70]"
  const glow = !showGlow ? "" : theme === "gold" ? "shadow-[0_0_15px_#CCA43B]" : theme === "blue" ? "shadow-[0_0_15px_#3727EA]" : ""
