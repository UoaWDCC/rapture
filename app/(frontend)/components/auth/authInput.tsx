...
export default function AuthInput({ type, placeholder, value, onChange, theme }: AuthInputProps) {
  const borderColor = theme === "gold" ? "border-[#F2B423]" : theme === "blue" ? "border-[#0650DA]" : "border-white"
  const inputBg = theme === "gold" ? "bg-[#F29123]/40" : theme === "blue" ? "bg-[#0650DA]/40" : "bg-transparent"
