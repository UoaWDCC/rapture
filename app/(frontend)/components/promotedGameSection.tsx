...
export function PromotedGameSection() {
  ...
  return (
    <section className="text-brand-blue my-10 w-full">
      <GlitchReveal>
        <div className="relative flex justify-center">
          <div className="hidden md:block bg-brand-blue/10 ">
            <Image
              alt="Book closed 1"
              width={155}
              height={663}
          ...
          <div className="relative">
            ...
            <div className="md:hidden w-full overflow-hidden bg-brand-blue/10">
              <Image
                alt="Book open"
                width={1010}
                height={674}
