  ...
  return (
    <div className="container mx-auto my-6 px-4 space-y-4">
      <PopUp
        title="Hello World"
        text={example_text}
        className="absolute top-100 right-50 w-200 z-50"
      />
      <PopUp
        src="/images/ivlnaud5zro61.png"
        alt="logo.png"
        width={550}
        height={700}
        className="absolute top-90 left-30 z-49"
      />

      <ContactFile
        title="test"
        bgColor="bg-amber-200"
        className="absolute top-250 left-5 w-250 h-150 z-98"
        classNameSide="mt-10"
      >
      ...
      <ContactFile
        title="test"
        bgColor="bg-blue-200"
        className="absolute top-250 -left-200 w-250 h-150 z-99"
        classNameSide="mt-20"
      >
      ...
      <ContactFile
        title="test"
        bgColor="bg-red-200"
        className="absolute top-250 -left-220 w-250 h-150 z-100"
        classNameSide="mt-40"
      >
        <div className="bg-amber-400">
          <br />
