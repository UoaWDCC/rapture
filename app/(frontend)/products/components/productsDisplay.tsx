...
export default async function ProductsDisplay(props: productProps) {
  ...
  return (
    <div className={`flex flex-row w-full group ${props.className}`}>
        ...
        <div className="inline-block overflow-y-hidden max-w-full ml-[-100%] pr-[10%] p-3 bg-black rounded-l-md transition ease-in-out duration-500 opacity-0 group-hover:opacity-70">
